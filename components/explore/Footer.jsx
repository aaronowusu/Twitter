...
const Footer = () => {
  return (
    <>
      ...
      <div className="hidden h-[72px] md:flex fixed bottom-0 items-center left-0 right-0 border-t dark:border-search-text-color bg-twitter-blue wrapper flex-row justify-around py-4  ">
        <div className="text flex flex-col">
          <span className="text-white font-bold text-2xl">Don&lsquo;t miss what&#39;s happening</span>
          <span className="text-white text-sm">People on Twitter are the first to know.</span>
        </div>
