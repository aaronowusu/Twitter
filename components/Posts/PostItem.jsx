...
const PostItem = ({ data, userId }) => {
  ...
  const LikeIcon = hasLiked ? (
    ...
    <svg
      viewBox='0 0 24 24'
      aria-hidden='true'
      className=' fill-search-text-color w-4 h-4 transition hover:fill-red-600'
    >
      <g>
          ...
          <div className='flex flex-row items-center text-search-text-color gap-10 cursor-pointer '>
            <div className='comments flex flex-row items-center gap-2 '>
              <span>
                <svg
                  viewBox='0 0 24 24'
                  aria-hidden='true'
                  className='fill-search-text-color w-4 h-4 transition hover:fill-twitter-blue'
                >
                  <g>
            ...
            <div className='retweet'>
              <svg
                viewBox='0 0 24 24'
                aria-hidden='true'
                className='fill-search-text-color w-4 h-4 transition hover:fill-green-500'
              >
                <g>
            ...
            <div
              className='likes flex flex-row items-center gap-2 '
              onClick={onLike}
            >
              <span>{LikeIcon}</span>
